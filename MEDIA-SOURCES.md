...
- Les réalisations du portfolio et le Reel sont issus des publications publiques de [Zirar Focus](https://www.instagram.com/zirar_focus/). Quatre photos ont été remplacées par les versions haute définition des mêmes publications ; leurs liens d’origine sont conservés dans `src/data/portfolio.ts`. Vérifier avec Zirar les autorisations de publication des personnes représentées.
